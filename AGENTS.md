...
Before making any changes, consult `./docs/AGENTS.md` for the project overview and coding rules. All modifications must be consistent with the existing architecture and design.
